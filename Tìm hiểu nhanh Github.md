...
- 1. Trên GitHub.com, điều hướng đến kho lưu trữ [octocat/Spoon-Knife](https://github.com/octocat/Spoon-Knife).
- 2. Phía trên danh sách các tệp, chọn **Code**.

    ![fork](./images/code.PNG)

- 3. Để sao chép kho lưu trữ bằng HTTPS, trong "Clone with HTTPS",nhấp chọn ![coppy](./images/coppy.PNG). Để sao chép kho lưu trữ bằng khóa SSH, bao gồm chứng chỉ do cơ quan cấp chứng chỉ SSH của tổ chức bạn cấp, hãy nhấp vào**Use SSH**, sau đó nhấp vào ![coppy](./images/coppy.PNG). Để sao chép kho lưu trữ bằng GitHub CLI, hãy nhấp vào **Use GitHub CLI**, sau đó nhấp vào ![coppy](./images/coppy.PNG).
...
- 4. Mở Git Bash.
- 5. Thay đổi các thư mục đến vị trí của ngã ba mà bạn đã nhân bản.
